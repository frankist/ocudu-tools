...
3. If the context output contains an `unstaged or untracked:` section, abort with an error listing those lines and tell the user to stage all intended changes before running `/commit`.
